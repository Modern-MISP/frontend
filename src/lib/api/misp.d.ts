...
export interface paths {
  ...
  "/worker/all/pause": {
     ...
     * Output:
     */
    post: operations["pause_workers_worker_all_pause_post"];
  };
  "/worker/all/unpause": {
    /**
     * Unpause Workers
     * @description Unpause all workers.
     *
     * Input:
     *
     * - the user's authentification status
     ...
     * Output:
     */
    post: operations["unpause_workers_worker_all_unpause_post"];
  };
  "/worker/all": {
    /**
     * Get Workers
...
export interface operations {
   ...
   * Output:
   */
  pause_workers_worker_all_pause_post: {
    responses: {
      /** @description Successful Response */
      200: {
        content: {
   ...
   * Output:
   */
  unpause_workers_worker_all_unpause_post: {
    responses: {
      /** @description Successful Response */
      200: {
        content: {
