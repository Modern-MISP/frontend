...
<div class="absolute w-full h-full flex flex-row macchiato bg-base text-text">
	<div class="bg-mantle p-2 relative rounded-md flex flex-col gap-6">
		...
		<div class="mt-auto flex flex-col gap-4 p-6">
			...
			<div class="flex justify-between">
				...
				<div class="text-2xl ml-auto rounded-full hover:text-sky cursor-pointer">
					<ChevronLeft />
				</div>
			</div>
		</div>
	...
	<div class="w-full h-full">
		...
		<main class="p-10 relative overflow-auto">
			<slot />
		</main>
	</div>
</div>
